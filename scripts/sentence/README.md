...
``` bash
  ...
  python scripts/sentence/cross_validation.py -subtask A -embeddings_path data/word_embeddings/word2vec_wiki-de_20161120_100 -strategy embedding_centroid_100 -c svm
  python scripts/sentence/cross_validation.py -subtask A -embeddings_path data/word_embeddings/word2vec_wiki-de_20161120_100 -strategy embedding_centroid_stopwords_100 -c svm
  python scripts/sentence/cross_validation.py -subtask A -embeddings_path data/word_embeddings/word2vec_wiki-de_20161120_100 -strategy n_unigram+pos_distribution+embedding_centroid -c svm
