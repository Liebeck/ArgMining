...
def build(feature_name='bag_of_words', ngram=1, token_form='text', lowercase=False, normalize=False):
    pipeline = Pipeline(
        [('transformer', BagOfWords(ngram=ngram, token_form=token_form, lowercase=lowercase)),
